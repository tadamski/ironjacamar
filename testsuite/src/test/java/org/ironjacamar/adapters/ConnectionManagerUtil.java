...
public class ConnectionManagerUtil
{
    ...
    */
   public static org.ironjacamar.core.connectionmanager.ConnectionManager extract(Object obj)
   {
            ...
            if (fields != null && fields.length > 0)
            {
               for (Field field : fields)
               {
                  ...
                  if (fieldType.equals(javax.resource.spi.ConnectionManager.class) ||
                      fieldType.equals(org.ironjacamar.core.connectionmanager.ConnectionManager.class))
                  {
                     field.setAccessible(true);
                     return (org.ironjacamar.core.connectionmanager.ConnectionManager) field.get(obj);
                  }
               }
            }
         }
         ...
         try
         {
            ...
            for (Method method : methods)
            {
               ...
               if (type.equals(javax.resource.spi.ConnectionManager.class) ||
                   type.equals(org.ironjacamar.core.connectionmanager.ConnectionManager.class))
               {
                  method.setAccessible(true);
                  return (org.ironjacamar.core.connectionmanager.ConnectionManager) method.invoke(obj, new Object[]
                  {});
               }
            }
         }

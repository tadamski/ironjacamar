...
public class MySQLReauthPlugin implements ReauthPlugin
{
   ...
   public synchronized void initialize(ClassLoader cl) throws SQLException
   {
      ...
      try
      {
         mysqlConnection = Class.forName("com.mysql.cj.jdbc.ConnectionImpl.java", true, cl);
      }
      catch (Throwable t)
      {
         // Ignore
      ...
      if (mysqlConnection == null)
      {
         try
         {
            mysqlConnection = Class.forName("com.mysql.cj.jdbc.ConnectionImpl.java", true,
      ...
      if (mysqlConnection == null)
      {
         try
         {
            ...
            mysqlConnection = Class.forName("com.mysql.cj.jdbc.ConnectionImpl.java", true, tccl);
         }
         catch (Throwable t)
         {
            // Ignore

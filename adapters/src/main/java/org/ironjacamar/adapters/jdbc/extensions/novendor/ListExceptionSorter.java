...
package org.ironjacamar.adapters.jdbc.extensions.novendor;
...
public class ListExceptionSorter implements ExceptionSorter, Serializable
{
   ...
   public void setFatalExceptions(String s)
   {
      ...
      {
         fatalSet.add(Integer.parseInt(st.nextToken()));
      }
   }
   ...
   public boolean isExceptionFatal(SQLException e)
   {
      ...
      if (fatalSet.contains(errorCode))
      {
         return true;
      }
